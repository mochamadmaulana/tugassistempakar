...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Form Edit Disease</h1>
    <?php if ($user['level'] == 1) : ?>
  ...
  <form action="<?= base_url('disease/update') ?>" method="post">
    <div class="row justify-content-center">
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <input type="text" name="name" id="name" class="form-control" autocomplete="off" placeholder="Disease name" value="<?= $disease['name'] ?>">
        </div>
